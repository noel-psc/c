 ...
 * 		在任何情况下，整数型的“字面量/数据”被当做int类型处理。
 * 		如果希望该“整数型字面量”被当做long类型来处理，需要在“字面量”后面添加L/l
 * 		建议使用大些L，因为小写l和1傻傻分不清。
 */
public class IntTest02 {
	public static void main(String[] args) {
		// 分析一下代码存在类型转换吗，一下代码什么意思？
		//不存在类型转换
		//100这个字面量被当做int处理
		//a变量是int类型，所以不存在类型转换。
		...
		//分析这个是否存在类型转换？
		//这个不存在类型转换。
		//在整数字面量300后面添加一个L之后，300L联合起来就是一个long类型的字面量
		//变量是long类型，long类型赋值给long类型不存在类型转换。
		long c = 300L;
		...
		//编译器会报错吗，为什么？
		//在java中，整数型字面量一上来编译器就会将它看作int类型
